...
from sokoenginepy import HexobanBoard, PuzzlesCollection, settings
    ...
    class describe_parser_tests:
        ...
        def it_parses_scheme1_type1(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme1_type1'], out_width=10,
                out_height=7
            )
        ...
        def it_parses_scheme2_type1(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme2_type1'], out_width=10,
                out_height=7
            )
        ...
        def it_parses_scheme3_type1(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme3_type1'], out_width=10,
                out_height=7
            )
        ...
        def it_parses_scheme4_type1(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme4_type1'], out_width=10,
                out_height=7
            )
        ...
        def it_parses_scheme1_type2(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme1_type2'], out_width=10,
                out_height=7
            )
        ...
        def it_parses_scheme2_type2(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme2_type2'], out_width=11,
                out_height=7
            )
        ...
        def it_parses_scheme3_type2(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme3_type2'], out_width=10,
                out_height=7
            )
        ...
        def it_parses_scheme4_type2(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_scheme4_type2'], out_width=11,
                out_height=7
            )
        ...
        def it_parses_hexocet_A(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_A'], out_width=9,
                out_height=10
            )
        ...
        def it_parses_hexocet_Perfume(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Perfume'], out_width=8,
                out_height=8
            )
        ...
        def it_parses_hexocet_Mud(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Mud'], out_width=7,
                out_height=10
            )
        ...
        def it_parses_hexocet_X(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_X'], out_width=7,
                out_height=8
            )
        ...
        def it_parses_hexocet_Wildmil(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Wildmil'], out_width=8,
                out_height=8
            )
        ...
        def it_parses_hexocet_Four(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Four'], out_width=8,
                out_height=9
            )
        ...
        def it_parses_hexocet_Bird(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Bird'], out_width=7,
                out_height=9
            )
        ...
        def it_parses_hexocet_V(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_V'], out_width=7,
                out_height=7
            )
        ...
        def it_parses_hexocet_Bridge(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Bridge'], out_width=8,
                out_height=9
            )
        ...
        def it_parses_hexocet_Gun(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Gun'], out_width=8,
                out_height=8
            )
        ...
        def it_parses_hexocet_Kite(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Kite'], out_width=8,
                out_height=9
            )
        ...
        def it_parses_hexocet_Fed(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Fed'], out_width=8,
                out_height=10
            )
        ...
        def it_parses_hexocet_Beetle(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Beetle'], out_width=8,
                out_height=9
            )
        ...
        def it_parses_hexocet_LittleRabbit(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_LittleRabbit'], out_width=7,
                out_height=7
            )
        ...
        def it_parses_hexocet_Losange(self):
            self.perform_parser_test(
                ...
                result=TEST_BOARDS['output_hexocet_Losange'], out_width=9,
                out_height=8
            )
