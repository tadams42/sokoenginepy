...
from sokoenginepy import (BoardConversionError, HexobanBoard,
                          PuzzlesCollection, settings)


def load_parser_test_data():
    input_file = os.path.join(TEST_RESOURCES_ROOT, 'test_data', 'hexoban_parser_tests.sok')
