...
class DescribeHashedBoardState:
    ...
    def it_hashes_board_layout(self, hashed_board_state):
        ...
        assert hashed_board_state.boxes_pusheres_layout_hash is not None
        assert hashed_board_state.boxes_layout_hash != hashed_board_state.boxes_pusheres_layout_hash
    ...
    def test_moving_box_modifies_hashes_consistently(self, hashed_board_state):
        ...
        initial_pus_hash = hashed_board_state.boxes_pusheres_layout_hash
        ...
        assert hashed_board_state.boxes_pusheres_layout_hash != initial_pus_hash
