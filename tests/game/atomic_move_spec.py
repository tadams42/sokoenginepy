...
from sokoenginepy import Direction, PieceConstants, InvalidPieceIdError
...
class DescribeAtomicMove(object):
    ...
    class Describe_init(object):
        def test_it_sets_all_attributes(self):
            ...
            assert_that(atomic_move._pusher_id, equal_to(PieceConstants.DEFAULT_ID))
    ...
    class Describe_moved_box_id(object):
        def test_get_returns_none_if_move_is_not_push_or_pull(
            ...
            atomic_move.moved_box_id = PieceConstants.DEFAULT_ID
        ...
        def test_get_returns_box_that_moved_if_move_is_push_or_pull(
            ...
            atomic_move.moved_box_id = PieceConstants.DEFAULT_ID + 42
            assert_that(atomic_move.moved_box_id, equal_to(PieceConstants.DEFAULT_ID + 42))
    ...
    class Describe_pusher_id(object):
        def test_it_returns_id_of_pusher_that_performed_movement(
            ...
            atomic_move.pusher_id = PieceConstants.DEFAULT_ID + 42
            assert_that(atomic_move.pusher_id, equal_to(PieceConstants.DEFAULT_ID + 42))
