...
class DescribeOctobanBoardGraph:
    class describe_neighbor_position:
        def test_generated_topLeft(self):
            ...
            row = 0
            column = 0
            puzzle = Puzzle(Tessellation.OCTOBAN, width, height)
            g = BoardGraph(puzzle)
            index = index_1d(column, row, width)

            assert is_octagon(g, index)
            ...
            assert g.neighbor(index, Direction.SOUTH_EAST) == index_1d(1, 1, width)
        ...
        def test_generated_topRight_columnOdd(self):
            ...
            assert column % 2 == 1 and not is_octagon(g, index)
            ...
            assert not is_on_board_1d(g.neighbor(index, Direction.UP), width, height)
            assert g.neighbor(index, Direction.DOWN) == index_1d(3, 1, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
        ...
        def test_generated_topRight_columnEven(self):
            ...
            assert column % 2 == 0 and is_octagon(g, index)

            assert g.neighbor(index, Direction.LEFT) == index_1d(3, 0, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.UP), width, height)
            assert g.neighbor(index, Direction.DOWN) == index_1d(4, 1, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
        ...
        def test_generated_bottomLeft_rowOdd(self):
            ...
            assert row % 2 == 1 and not is_octagon(g, index)

            assert not is_on_board_1d(g.neighbor(index, Direction.LEFT), width, height)
            assert g.neighbor(index, Direction.RIGHT) == index_1d(1, 3, width)
            assert g.neighbor(index, Direction.UP) == index_1d(0, 2, width)
        ...
        def test_generated_bottomLeft_rowEven(self):
            ...
            assert row % 2 == 0 and is_octagon(g, index)

            assert not is_on_board_1d(g.neighbor(index, Direction.LEFT), width, height)
            assert g.neighbor(index, Direction.RIGHT) == index_1d(1, 4, width)
            assert g.neighbor(index, Direction.UP) == index_1d(0, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.DOWN), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
        ...
        def test_generated_bottomRight_rowEven_columnEven(self):
            ...
            assert row % 2 == 0 and column % 2 == 0 and is_octagon(g, index)

            assert g.neighbor(index, Direction.LEFT) == index_1d(3, 4, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(4, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.DOWN), width, height)
        ...
        def test_generated_bottomRight_rowEven_columnOdd(self):
            ...
            assert row % 2 == 0 and column % 2 == 1 and not is_octagon(g, index)

            assert g.neighbor(index, Direction.LEFT) == index_1d(2, 4, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(3, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.DOWN), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
        ...
        def test_generated_bottomRight_rowOdd_columnEven(self):
            ...
            assert row % 2 == 1 and column % 2 == 0 and not is_octagon(g, index)

            assert g.neighbor(index, Direction.LEFT) == index_1d(3, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(4, 2, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.DOWN), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
        ...
        def test_generated_bottomRight_rowOdd_columnOdd(self):
            ...
            assert row % 2 == 1 and column % 2 == 1 and is_octagon(g, index)

            assert g.neighbor(index, Direction.LEFT) == index_1d(2, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(3, 2, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.DOWN), width, height)
        ...
        def test_generated_midleTop_columnEven(self):
            ...
            assert g.neighbor(index, Direction.SOUTH_WEST) == index_1d(3, 1, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
            assert g.neighbor(index, Direction.SOUTH_EAST) == index_1d(5, 1, width)
        ...
        def test_generated_midleBottom_columnOdd_rowEven(self):
            ...
            assert column % 2 == 1 and row % 2 == 0 and not is_octagon(g, index)
        ...
        def test_generated_middleBottom_columnEven_rowEven(self):
            ...
            assert column % 2 == 0 and row % 2 == 0 and is_octagon(g, index)
        ...
        def test_generated_midleBottom_columnOdd_rowOdd(self):
            ...
            assert column % 2 == 1 and row % 2 == 1 and is_octagon(g, index)
        ...
        def test_generated_middleBottom_columnEven_rowOdd(self):
            ...
            assert column % 2 == 0 and row % 2 == 1 and not is_octagon(g, index)
        ...
        def test_generated_midleLeft_rowOdd(self):
            ...
            assert g.neighbor(index, Direction.RIGHT) == index_1d(1, 3, width)
            assert g.neighbor(index, Direction.UP) == index_1d(0, 2, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(0, 4, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_EAST), width, height)
        ...
        def test_generated_midleLeft_rowEven(self):
            ...
            assert g.neighbor(index, Direction.UP) == index_1d(0, 1, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(0, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert g.neighbor(index, Direction.NORTH_EAST) == index_1d(1, 1, width)
            assert g.neighbor(index, Direction.SOUTH_EAST) == index_1d(1, 3, width)
        ...
        def test_generated_midleRight_rowOdd_columnOdd(self):
            ...
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(3, 2, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(3, 4, width)
            assert g.neighbor(index, Direction.NORTH_WEST) == index_1d(2, 2, width)
        ...
        def test_generated_midleRight_rowEven_columnOdd(self):
            ...
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(3, 1, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(3, 3, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_EAST), width, height)
        ...
        def test_generated_midleRight_rowOdd_columnEven(self):
            ...
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(4, 2, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(4, 4, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_EAST), width, height)
        ...
        def test_generated_midleRight_rowEven_columnEven(self):
            ...
            assert not is_on_board_1d(g.neighbor(index, Direction.RIGHT), width, height)
            assert g.neighbor(index, Direction.UP) == index_1d(4, 1, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(4, 3, width)
            assert g.neighbor(index, Direction.NORTH_WEST) == index_1d(3, 1, width)
        ...
        def test_generated_midle_rowOdd_columnEven(self):
            ...
            assert g.neighbor(index, Direction.UP) == index_1d(2, 2, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(2, 4, width)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_WEST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.NORTH_EAST), width, height)
            assert not is_on_board_1d(g.neighbor(index, Direction.SOUTH_EAST), width, height)
        ...
        def test_generated_midle_rowEven_columnEven(self):
            ...
            assert g.neighbor(index, Direction.UP) == index_1d(2, 1, width)
            assert g.neighbor(index, Direction.DOWN) == index_1d(2, 3, width)
            assert g.neighbor(index, Direction.NORTH_WEST) == index_1d(1, 1, width)
            assert g.neighbor(index, Direction.SOUTH_WEST) == index_1d(1, 3, width)
            assert g.neighbor(index, Direction.NORTH_EAST) == index_1d(3, 1, width)
