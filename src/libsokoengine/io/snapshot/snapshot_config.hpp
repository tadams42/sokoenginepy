  ...
  namespace io {
    namespace snapshot_parsing {
      ...
      namespace parser {
        ...
        typedef x3::phrase_parse_context<x3::ascii::space_type>::type
          phrase_context_type;

        // Combined Error Handler and Phrase Parse Context. This parsing context should
        // be used in combination with `x3::phrase_parse`, ie:
        //
