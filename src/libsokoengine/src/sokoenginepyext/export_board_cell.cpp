...
void export_board_cell(py::module &m) {
  py::class_<BoardCell>(m, "BoardCell")
      ...
      .def_static("is_empty_floor_chr", &BoardCell::is_empty_floor_chr,
                  py::arg("character"))
      ...
      .def_property("is_deadlock", &BoardCell::is_deadlock,
                    &BoardCell::set_is_deadlock);
}
