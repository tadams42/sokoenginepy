...
public:
  ...
  PIMPL(
    const Positions& pushers_positions, const Positions& boxes_positions,
...
bool BoardState::operator== (const BoardState& rv) const {
    return (
        m_impl->m_zobrist_hash != UNKNOWN_ZOBRIST_HASH
...
Positions& BoardState::pushers_positions() {
  return m_impl->m_pushers_positions;
}
...
Positions& BoardState::boxes_positions() {
  return m_impl->m_boxes_positions;
}

zobrist_key_t BoardState::zobrist_hash() const {
  return m_impl->m_zobrist_hash;
}

zobrist_key_t& BoardState::zobrist_hash() {
  return m_impl->m_zobrist_hash;
}
