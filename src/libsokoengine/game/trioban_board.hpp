#ifndef TRIOBAN_BOARD_0FEA723A_C86F_6753_04ABD475F6FCA5FB
#define TRIOBAN_BOARD_0FEA723A_C86F_6753_04ABD475F6FCA5FB
...
public:
  TriobanBoard();
  TriobanBoard(board_size_t width, board_size_t height);
