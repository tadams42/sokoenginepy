#ifndef HEXOBAN_BOARD_0FEA723A_C86F_6753_04ABD475F6FCA5FB
#define HEXOBAN_BOARD_0FEA723A_C86F_6753_04ABD475F6FCA5FB
...
public:
  ...
  virtual void remove_row_top(VariantBoard &board,
                              bool reconfigure_edges) const override;
  virtual void remove_row_bottom(VariantBoard &board,
                                 bool reconfigure_edges) const override;

  virtual void reverse_columns(VariantBoard &board,
                               bool reconfigure_edges) const override;
};
...
public:
  ...
  virtual Strings parse(const std::string &board_str) const override;
};
...
public:
  ...
  virtual std::string print(const VariantBoard &board,
                            bool use_visible_floor = false) const override;
};
