#ifndef TRIOBAN_COMMON_SKINS_FORMAT_0FEA723A_C86F_6753_04ABD475F6FCA5FB
#define TRIOBAN_COMMON_SKINS_FORMAT_0FEA723A_C86F_6753_04ABD475F6FCA5FB
...
public:
  TriobanCommonSkinsFormat(uint8_t rows_count_hint, uint8_t columns_count_hint);
  TriobanCommonSkinsFormat(TriobanCommonSkinsFormat &)            = delete;
  TriobanCommonSkinsFormat &operator=(TriobanCommonSkinsFormat &) = delete;
  ...
  virtual point_t canvas_size(board_size_t board_width, board_size_t board_height) const override;
};
