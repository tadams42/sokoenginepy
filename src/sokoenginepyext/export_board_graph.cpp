...
void export_board_graph(py::module &m) {
  ...
  py::class_<Edge>(m, "Edge")
    .def(py::init<position_t, position_t, Direction>(), py::arg("u"), py::arg("v"),
         py::arg("direction"))
    ...
    .def_property(
      "u", [](const Edge &self) { return self.u; },
      [](Edge &self, position_t rv) { self.u = rv; })
    .def_property(
      "v", [](const Edge &self) { return self.v; },
      [](Edge &self, position_t rv) { self.v = rv; })
    .def_property(
      "direction", [](const Edge &self) { return self.direction; },
      [](Edge &self, Direction rv) { self.direction = rv; });
  ...
  py::class_<BoardGraph>(m, "BoardGraph")
    ...
    .def(
      ...
      [](const BoardGraph &self, py_int_t position) {
        if (position < 0 ||
            position >= std::numeric_limits<sokoengine::position_t>::max())
          return false;
    ...
    .def(
      ...
      [](const BoardGraph &self, py_int_t pusher_position,
      ...
      py::arg("pusher_position"), py::arg("excluded_positions") = py_int_vect_t())

    .def(
      "normalized_pusher_position",
      [](const BoardGraph &self, py_int_t pusher_position,
         const py_int_vect_t &excluded_positions) {
        return self.normalized_pusher_position(position_or_throw(pusher_position),
                                               positions_no_throw(excluded_positions));
      },
      py::arg("pusher_position"), py::arg("excluded_positions") = py_int_vect_t())
