...
void export_io_collection(py::module &m) {
  ...
  pyCollection.def("load", py::overload_cast<const path &>(&Collection::load))
    .def("load", py::overload_cast<const path &, Tessellation>(&Collection::load))
  ...
  pyCollection
    .def("save", py::overload_cast<const path &>(&Collection::save, py::const_))
